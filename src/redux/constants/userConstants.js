...
export const USER_EDIT_UPDATE_PASSWORD_REQUEST = "USER_EDIT_UPDATE_PASSWORD_REQUEST";
export const USER_EDIT_UPDATE_PASSWORD_SUCCESS = "USER_EDIT_UPDATE_PASSWORD_SUCCESS";
export const USER_EDIT_UPDATE_PASSWORD_FAIL = "USER_EDIT_UPDATE_PASSWORD_FAIL";
export const USER_EDIT_UPDATE_PASSWORD_RESET = "USER_EDIT_UPDATE_PASSWORD_RESET";